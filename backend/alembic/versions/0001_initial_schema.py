...
def upgrade() -> None:
    ...
    op.create_index("ix_github_installations_github_installation_id", "github_installations", ["github_installation_id"])
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column("workspace_id", UUID(as_uuid=True), sa.ForeignKey("workspaces.id", ondelete="CASCADE"), nullable=False),
        sa.Column("github_installation_id", UUID(as_uuid=True), sa.ForeignKey("github_installations.id", ondelete="CASCADE"), nullable=False),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.UniqueConstraint("github_installation_id", "github_repository_id", name="uq_installation_repository"),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column("repository_id", UUID(as_uuid=True), sa.ForeignKey("repositories.id", ondelete="CASCADE"), nullable=False),
        sa.Column("first_scan_id", UUID(as_uuid=True), sa.ForeignKey("scans.id", ondelete="SET NULL"), nullable=True),
        sa.Column("last_scan_id", UUID(as_uuid=True), sa.ForeignKey("scans.id", ondelete="SET NULL"), nullable=True),
        sa.Column("category", sa.String(30), nullable=False),
    ...
    op.create_index("ix_scoring_configurations_workspace_id", "scoring_configurations", ["workspace_id"])

    # ── scoring_weights ───────────────────────────────────────────────────────
    op.create_table(
        "scoring_weights",
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column("scoring_configuration_id", UUID(as_uuid=True), sa.ForeignKey("scoring_configurations.id", ondelete="CASCADE"), nullable=False),
        sa.Column("category", sa.String(30), nullable=False),
        sa.Column("weight", sa.Float(), nullable=False),
        sa.UniqueConstraint("scoring_configuration_id", "category", name="uq_scoring_weight_category"),
    )
    op.create_index("ix_scoring_weights_scoring_configuration_id", "scoring_weights", ["scoring_configuration_id"])
    ...
    op.create_table(
        ...
        sa.Column("repository_id", UUID(as_uuid=True), sa.ForeignKey("repositories.id", ondelete="CASCADE"), nullable=False),
        sa.Column("scan_id", UUID(as_uuid=True), sa.ForeignKey("scans.id", ondelete="CASCADE"), nullable=False),
        sa.Column("scoring_configuration_id", UUID(as_uuid=True), sa.ForeignKey("scoring_configurations.id", ondelete="RESTRICT"), nullable=False),
    ...
    op.create_table(
        "health_score_categories",
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column("health_score_id", UUID(as_uuid=True), sa.ForeignKey("health_scores.id", ondelete="CASCADE"), nullable=False),
        sa.Column("category", sa.String(30), nullable=False),
    ...
    op.create_index("ix_health_score_categories_health_score_id", "health_score_categories", ["health_score_id"])
    ...
    op.create_table(
        ...
        sa.Column("ai_analysis_id", UUID(as_uuid=True), sa.ForeignKey("ai_analyses.id", ondelete="SET NULL"), nullable=True),
        sa.Column("title", sa.String(512), nullable=False),
        sa.Column("description", sa.Text(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("workspace_id", UUID(as_uuid=True), sa.ForeignKey("workspaces.id", ondelete="CASCADE"), nullable=False),
        sa.Column("repository_id", UUID(as_uuid=True), sa.ForeignKey("repositories.id", ondelete="CASCADE"), nullable=False),
        sa.Column("recommendation_id", UUID(as_uuid=True), sa.ForeignKey("recommendations.id", ondelete="SET NULL"), nullable=True),
